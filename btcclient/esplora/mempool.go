...
func (c *EsploraClient) GetMempoolInfo() (MempoolInfo, error) {
...
func (c *EsploraClient) GetMempoolTxids() ([]string, error) {
	var txids []string
...
func (c *EsploraClient) GetRecentMempoolTxs() ([]Transaction, error) {
	var txs []Transaction
