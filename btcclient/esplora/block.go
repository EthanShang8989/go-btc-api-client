...
func (c *EsploraClient) GetBlockHeaderByhash(hash string) (*BlockHeader, error) {
...
func (c *EsploraClient) GetBlockHeaderHex(hash string) (string, error) {
	var header string
...
func (c *EsploraClient) GetBlockStatus(hash string) (BlockStatus, error) {
...
func (c *EsploraClient) GetBlockTransactions(hash string, startIndex ...int) ([]Transaction, error) {
...
// GetBlockAllTxids fetches a list of all txids in a block by hash
func (c *EsploraClient) GetBlockAllTxids(hash string) ([]string, error) {
	var txids []string
...
func (c *EsploraClient) GetBlockAllTransactions(hash string) ([]Transaction, error) {
	// Get all txids in the block
	txids, err := c.GetBlockAllTxids(hash)
	if err != nil {
		return nil, err
	}
...
func (c *EsploraClient) GetTxidByBlockhashAndIndex(hash string, index int) (string, error) {
	var tx string
...
func (c *EsploraClient) GetBlockRaw(hash string) ([]byte, error) {
...
func (c *EsploraClient) GetBlockHashByHeight(height int) (string, error) {
	var hash string
	err := c.sendRequest(fmt.Sprintf("/block-height/%d", height), &hash)
	return hash, err
}

// GetRecentBlocks fetches the 10 newest blocks starting at the tip or at the specified start height
func (c *EsploraClient) GetRecentBlocks(startHeight ...int) ([]BlockHeader, error) {
	endpoint := "/blocks"
...
func (c *EsploraClient) GetTipBlockHeight() (int, error) {
	var height int
...
func (c *EsploraClient) GetTipBlockHash() (string, error) {
	var hash string
