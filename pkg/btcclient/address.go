...
func (c *Client) GetScripthashInfo(hash string) (ScripthashInfo, error) {
...
func (c *Client) GetScripthashTxs(hash string) ([]map[string]interface{}, error) {
...
func (c *Client) GetAddressNewestTxsStartFromTxid(address string, lastSeenTxid ...string) ([]Transaction, error) {
...
// Returns 25 transactions per page. More can be requested by specifying the last txid seen by the previous query.
func (c *Client) GetScripthashNewestTxsStartFromTxid(hash string, lastSeenTxid ...string) ([]Transaction, error) {
...
func (c *Client) GetAllAddressTxs(address string) ([]Transaction, error) {
...
//WARM: It may take a long time if there are many tx at one address.
func (c *Client) GetAllScripthashTxs(hash string) ([]Transaction, error) {
	var allTxs []Transaction
	var lastTxid string
	for {
...
func (c *Client) GetAddressTxsMempool(address string) ([]Transaction, error) {
	var txs []Transaction
...
func (c *Client) GetScripthashTxsMempool(hash string) ([]Transaction, error) {
	var txs []Transaction
...
func (c *Client) GetScripthashUtxos(hash string) ([]Utxo, error) {
	var utxos []Utxo
...
func (c *Client) SearchAddressesByPrefix(prefix string) ([]string, error) {
